...
float datos_prueba[5]={6.2,2.9,4.3,1.3,2};
int respuesta;
void setup() {
 Serial.begin(9600);
}
...
void loop() {
  ...
  Serial.print("La etiqueta que corresponde al dato de prueba es :");
   ...
   for(i=0;i<etiquetas;i++){
     ...
     */
     ...
     for(fil=0;fil<tam_fil;fil++){
        ...
        //contar por columna, cuantos vecinos hay por etiquetas
        for(i=0;i<etiquetas;i++){
          for(j-0;j<k;j++){
